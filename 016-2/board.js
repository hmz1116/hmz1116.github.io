...
var PIECE_NAME = [
  ...
  "rk", "ra", "rb", "rn", "rr", "rc", "rp", "rs", "rd", "rv", "rx", "rf", "rw", "rt", "rz", "ru", "ro", "rl", "ri", "rbt", "rdm", "rd1", "rd2", "rxb", "rxxb", null, null, null, null, null, null, null,
  "bk", "ba", "bb", "bn", "br", "bc", "bp", "bs", "bd", "bv", "bx", "bf", "bw", "bt", "bz", "bu", "bo", "bl", "bi", "bbt", "bdm", "bd1", "bd2", "bxb", "bxxb", null, null, null, null, null, null, null,
];
...
function Board(container, images, sounds) {
  ...
  this.pos.fromFen("rn[xxb]aka[xxb]nr/9/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/9/RN[XXB]AKA[XXB]NR Xxw - - 0 1");
  this.animated = true;
  this.sound = true;
  this.search = null;
  this.imgSquares = [];
