...
var PIECE_NAME = [
  ...
  "rk", "ra", "rb", "rn", "rr", "rc", "rp", "rs", "rd", "rv", "rx", "rf", "rw", "rt", "rz", "ru", "ro", "rl", null, null, null, null, null, null, null, null, null, null, null, null, null, null,
  "bk", "ba", "bb", "bn", "br", "bc", "bp", "bs", "bd", "bv", "bx", "bf", "bw", "bt", "bz", "bu", "bo", "bl", null, null, null, null, null, null, null, null, null, null, null, null, null, null,
];
  ...
  if ((pc & SIDE_TAG(this.pos.sdPlayer)) != 0) {
    if(this.pcLready[sd]){
      if(this.sqReady == sq){
        ...
        if(this.pcLsqSelected > 0)this.drawSquare(this.pcLsqSelected, false);
        this.pcLsqSelected = sq;
      }
      this.drawSquare(sq, true);
    }
    ...
    else if(this.pcLready[sd] && (this.pos.squares[this.sqSelected] & PCNOMAX) == PIECE_DEVIL && this.pcLsqSelected > 0){
      this.addMove(MOVE(this.sqSelected, sq, MTYPE_DEVIL, this.pcLsqSelected), false);
    }
    else{
      this.addMove(MOVE(this.sqSelected, sq), false);
    }
