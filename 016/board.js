...
var PIECE_NAME = [
  ...
  "rk", "ra", "rb", "rn", "rr", "rc", "rp", "rs", "rd", "rv", "rx", "rf", "rw", "rt", "rz", "ru", "ro", "rl", "ri", "rbt", "rdm", "rd1", "rd2", null, null, null, null, null, null, null, null, null,
  "bk", "ba", "bb", "bn", "br", "bc", "bp", "bs", "bd", "bv", "bx", "bf", "bw", "bt", "bz", "bu", "bo", "bl", "bi", "bbt", "bdm", "bd1", "bd2", null, null, null, null, null, null, null, null, null,
];
...
Board.prototype.drawSquare = function(sq, selected, oosgif = "oos.gif") {
  ...
  switch (this.pos.pksquares[this.flipped(sq)]) {
    case PLUSKIND_NULL:
