...
var PIECE_NAME = [
  ...
  "rk", "ra", "rb", "rn", "rr", "rc", "rp", "rs", "rd", "rv", "rx", "rf", "rw", "rt", "rz", null,
  "bk", "ba", "bb", "bn", "br", "bc", "bp", "bs", "bd", "bv", "bx", "bf", "bw", "bt", "bz", null,
];
...
function Board(container, images, sounds) {
  ...
  this.pos.fromFen("rnbakabnr/9/1c5c1/z1p1p1p1z/9/9/Z1P1P1P1Z/1C5C1/9/RNBAKABNR Xxw - - 0 1");
  this.animated = true;
  this.sound = true;
  this.search = null;
  this.imgSquares = [];
...
Board.prototype.clickSquare = function(sq_) {
  ...
  if ((pc & SIDE_TAG(this.pos.sdPlayer)) != 0 && !this.phantomready[sd]) {
    ...
    else if(this.pcKZready[sd] && (this.pos.squares[this.sqSelected] & 15) == 0){
      for(var i = 16; i < 20; i++){
    ...
    else if(this.pcZready[sd] && (this.pos.squares[this.sqSelected] & 15) == 14){
      for(var i = 16; i < 20; i++){
